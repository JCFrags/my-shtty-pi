export const DEFAULT_PARENT_TOOL_NAMES = ["orchestrate"];
...
export const PARENT_TOOL_METADATA = Object.freeze(METADATA);
export function parentToolMetadata(tool) {
    return PARENT_TOOL_METADATA[tool];
}
export function parentToolMethod(tool) {
    return parentToolMetadata(tool).method;
}
function isRecord(value) {
    return typeof value === "object" && value !== null && !Array.isArray(value);
}
export function validateParentToolRequest(value) {
    const issues = [];
    if (!isRecord(value))
        return {
            valid: false,
    ...
    if (!PARENT_TOOL_NAMES.includes(value.tool))
...
export function isParentToolRequest(value) {
