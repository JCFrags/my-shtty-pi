...
import { createSessionHealthSnapshot } from '../integration/doctor.js';
import { createDiagnostics } from '../services/diagnostics.js';
const ACCESS_ERRORS = Object.freeze({
...
export class RuntimeSlot {
    ...
    replaceLocked(runtime) {
        this.#runtime = runtime;
    }
    clearIfGenerationLocked(generation) {
        if (this.#runtime?.generation !== generation)
            return false;
        this.#runtime = undefined;
        return true;
    }
    requireHealthyLocked() {
    ...
    doctorSnapshot(context) {
        ...
        if (runtime === undefined)
            return uninitializedSnapshot(context);
...
function uninitializedSnapshot(context) {
