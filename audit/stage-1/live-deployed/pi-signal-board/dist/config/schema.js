...
const deliveryModeSchema = Type.Union([Type.Literal('steer'), Type.Literal('followUp'), Type.Literal('nextTurn')], { default: 'steer' });
const blockingPolicySchema = Type.Union([Type.Literal('never'), Type.Literal('when_agent_settles')], { default: 'when_agent_settles' });
/** Runtime form of schemas/config.schema.json. */
export const configDocumentSchema = deepFreeze(Type.Object({
    schemaVersion: Type.Literal(1),
    enabled: Type.Optional(Type.Boolean({ default: true })),
    widget: Type.Optional(Type.Object({
        enabled: Type.Optional(Type.Boolean({ default: true })),
        ...
        showCompletedForMinutes: Type.Optional(Type.Integer({ minimum: 0, maximum: 1440, default: 10 })),
    ...
    questions: Type.Optional(Type.Object({
    ...
    limits: Type.Optional(Type.Object({
        maxActiveUpdates: Type.Optional(Type.Integer({ minimum: 1, maximum: 200, default: 50 })),
        maxActionableQuestions: Type.Optional(Type.Integer({ minimum: 1, maximum: 100, default: 20 })),
        visibleHistoryLimit: Type.Optional(Type.Integer({ minimum: 50, maximum: 2000, default: 500 })),
        maxUpdateMutationsPerTurn: Type.Optional(Type.Integer({ minimum: 1, maximum: 50, default: 12 })),
        maxQuestionMutationsPerTurn: Type.Optional(Type.Integer({ minimum: 1, maximum: 20, default: 5 })),
        maxAcknowledgementsPerTurn: Type.Optional(Type.Integer({ minimum: 1, maximum: 100, default: 20 })),
    }, { additionalProperties: false })),
    ui: Type.Optional(Type.Object({
        wideLayoutMinimumColumns: Type.Optional(Type.Integer({ minimum: 80, maximum: 160, default: 100 })),
    ...
    description: 'Global or trusted-project configuration. Unknown properties and null values are rejected. Missing fields inherit lower-precedence values/defaults.',
    additionalProperties: false,
}));
/** Validate one complete source document without applying defaults or coercion. */
export function isConfigDocument(value) {
