...
- `npm run test` builds to ignored `dist-test/` and runs the 54-file suite serially (`--test-concurrency=1`) against temporary synthetic data; serial execution avoids cross-file scheduler-test starvation.
