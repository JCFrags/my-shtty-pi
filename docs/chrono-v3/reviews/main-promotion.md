...
Strict native source build and probe passed on Node 24.18.0 with native SHA-256 `baac38739b5e4c5137ea0514c451df58423c2e626f43cddcfb4542206f93d013`. The probe confirmed allocation refusal. Typecheck, generated build and root static verification passed. The root static gate ran its existing 18 indexed-input/integrity checks. No broad local runtime or scale campaign ran. Required promotion CI remains pending.

The integrated package has 415 indexed files, Git tree `59ea1ed0a7bf5cd9a733e1183327fafb809693cf`, and 18 declared differences from the M10 upstream package tree. The current root verifier records every changed path and both available digests, rather than calling the runtime changes test-only.
