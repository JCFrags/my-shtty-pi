...
| M03 — transactional runtime and scheduler | changes requested; not accepted | Project-lead review at `b5452ffdd0f330209491ff368db4fa85d154bc25`: F001 failure-atomic admission and F002 locally bounded waiters; corrections pending. [M03 runtime report](./reviews/M03-runtime-report.md) retains prior 2.0.3 deployment evidence, not evidence of finding resolution | PR #35 remains draft and unmerged; verified rollback to 2.0.2; acceptance belongs to project lead; M04 additionally requires separate proposal review and explicit directing-assistant authorization |
