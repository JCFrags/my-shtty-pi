...
| M03 — transactional runtime and scheduler | changes requested; not accepted | Project-lead review at `b5452ffdd0f330209491ff368db4fa85d154bc25`: F001 failure-atomic admission and F002 locally bounded waiters; corrections implemented and submitted for re-review. [M03 runtime report](./reviews/M03-runtime-report.md) records 412 tests, both heap lanes, 54-job deployed recovery soak, exact-source CI 34140039294/34140043742, and 2.0.4 deployment at `ad23f0b71ee473d33aff26d367459e76d208c631` | PR #35 remains draft and unmerged; verified fresh rollback to 2.0.3 and retained older 2.0.2 recovery; acceptance belongs to project lead; M04 additionally requires separate proposal review and explicit directing-assistant authorization |
