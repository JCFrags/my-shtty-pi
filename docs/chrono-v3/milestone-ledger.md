...
| M04 — incremental source catalog | authorized; implementation in progress, not accepted | Dedicated branch `work/chrono-v3-m04-catalog` from M03 integration merge; [A-0004](./amendments/A-0004-v3-timeline-and-catalog-scope.md) records approved scope and later quality boundaries | Default-off shadow only; synthetic canaries permitted; production 2.0.4 and backups unchanged; M05 and catalog activation not authorized |
