...
| M02 — deterministic test foundation | active on `work/chrono-v3-m02-test-foundation` | [M02 test-foundation report](./reviews/M02-test-foundation-report.md), deterministic profiles, unified normal/fixed-heap commands, fault injection, 512 MiB/1 GiB lanes, deployed-worker soak, and reproduced M01 memory findings | narrow `2.0.2` hotfix candidate requires complete gates and guarded activation; draft unmerged PR must target `rebuild/chrono-memory-v3`; no M03 |
...
The R2 gates were accepted by the directing assistant at reviewed head `9a2dbe13a15e9d4418d8a843ffa28ceb272cbff2`. M01 was accepted at evidence head `aa079f87d5bb4e8756e4392a521108430551308a`, merged only into `rebuild/chrono-memory-v3` as `0a1ca2ff16d8b79db3fda88f156ea5b9c6864427`, and remains healthy locally at deployed commit `24c6f13f1f6ac9468dfbeba4cad8021b44ecae7f`. M02 is active; `main` and M03 remain outside this boundary.
