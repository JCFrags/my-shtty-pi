...
| M03 — transactional runtime and scheduler | implemented and deployed; awaiting user review | [M03 runtime report](./reviews/M03-runtime-report.md); deployed `7449c03240dd6b69426fd678cb453c89621d9e4d`, version 2.0.3; 370/370 package tests, fixed-heap lanes, exact-head CI, bounded history, kernel-held slots, independent-client faults and 36-job deployed soak passed | PR #35 remains draft and unmerged; verified rollback to 2.0.2; no M04; acceptance belongs to user |
