...
export const ERROR_DEFINITIONS = {
    ...
    SB_STATE_CONFLICT: {
        message: 'The requested operation conflicts with the current board state. Refresh and try again.',
        retryable: true,
    },
    SB_REVISION_MISMATCH: {
...
export function fieldError(path, reason) {
...
export function signalBoardError(code, fieldErrors) {
 ...
 */
export function convertUnexpectedError(_cause, boundary) {
...
function copyFieldError(error) {
    const reason = Object.values(FIELD_ERROR_MESSAGES).includes(error.message)
        ? error.message
...
function safeCorrelationId(generator) {
    try {
