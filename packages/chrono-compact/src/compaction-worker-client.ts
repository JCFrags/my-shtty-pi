...
function safeFailure(request: CompactionWorkerRequest, code: WorkerFailureCode): CompactionWorkerResponse { return { schemaVersion: 1, jobId: request.jobId, status: "failed", jobType: request.jobType, failureCode: code, metrics: { workerPid: 0, totalWallMs: 0, compactionMs: 0, cpuUserMicros: 0, cpuSystemMicros: 0, peakRssKiB: 0, priorityApplied: false, cacheState: "disabled", modelCalls: 0, networkCalls: 0, secretSentinelPresent: false } }; }
