...
export class ChannelStore {
  ...
  async events(runIds: string[]): Promise<ChannelEvent[]> {
    ...
    const wanted = new Set(runIds),
      legacyNames = (await readdir(this.eventsDirectory))
  ...
  async waitForChange(runIds: string[], timeoutMs: number): Promise<void> {
