...
function initialChecks(manifest) {
  return {
    ...
    canonicalTuiPeer: manifest.peerDependencies?.["@earendil-works/pi-tui"] === ">=0.85.1 <0.86.0",
    canonicalTuiDevelopmentDependency: manifest.devDependencies?.["@earendil-works/pi-tui"] === "0.85.1",
